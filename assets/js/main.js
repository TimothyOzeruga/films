    ...
    methods:{
        searchMovie(e){
            ...
            if(this.search!==''){
                ...
                this.page = 1;
                axios
                    .get('https://www.omdbapi.com/?apikey='+Omdb_Api_key+'&s='+this.search+'&type='+this.type+'&y='+this.year+'&page='+this.page)
                    .then((resp)=>{
        ...
        changeStar(rez){
            ...
            for(let i=0; i<rds.length; i++){
                let ind = this.fav_list.findIndex((el)=> el.imdbID === rds[i].imdbID);
                if(ind!=-1){
                    rds[i].inFav = true;
                }else{
                    rds[i].inFav = false;
        ...
        detail(imdbID){
            axios
                    .get('https://www.omdbapi.com/?apikey='+Omdb_Api_key+'&i='+imdbID+'&plot=full')
                    .then((resp)=>{
